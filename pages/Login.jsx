import { View, Text, TextInput, Button, TouchableOpacity, TouchableOpacityBase, ToastAndroid, Switch, Image, KeyboardAvoidingView, ScrollView } from 'react-native'
...
<View>
  ...
  Here you can login to your account </Text>
     ...
     <Text className='font-semibold'>
      ...
      <TouchableOpacity onPress={()=>navigation.navigate('Signup')} className='justify-end mb-5 flex-row w-full'>
      <Text className='text-blue-600'>not have account?</Text>
      </TouchableOpacity>
     
      
      <TouchableOpacity onPress={handleLogin} className='bg-black mb-5 p-2 rounded-3xl w-[60%] '>
